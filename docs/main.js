...
function mostrarPerfilCTD(id) {
  ...
  const profundidad = datos.map(f => parseFloat(f[columnas[1]])); // 👈 AÑADIDO: definimos profundidad

  const coloresLinea = ["#0074D9", "#FF4136", "#2ECC40"]; // colores para los 3 gráficos
